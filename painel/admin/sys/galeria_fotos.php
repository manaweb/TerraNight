...
<table>
  <tr><th style="padding:0;">Titulo:</th><td><b><?=$dados2['titulo'];?></b></td></tr>
  <tr><th style="padding:0;">Data:</th><td><?=$dados2['data1'];?></td></tr>
  <tr><th style="padding:0;">Descricao:</th><td><?=$dados2['descricao'];?></td></tr>
  <img src="../../img.php?img=arquivos/galeria/<?=$dados2['codigo'];?>/capa.jpg&x=360&y=234&corta=1" />
  </td></tr>
</table>
</fieldset>
...
<fieldset class="adicionar">
	<legend>
        ...
        <span style="font-size:15px;">
            <input id="uploadType1" type="radio" name="uploadType" value="2" style="border:0" onclick="mudaUploadTipo(this.value);" checked="checked"> <label for="uploadType1">Formul&aacute;rio</label>
