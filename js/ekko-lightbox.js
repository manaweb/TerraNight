...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    header = '<div class="modal-header"' + (this.options.title ? '' : ' style="display:block"') + '><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title"></h4></div>';
